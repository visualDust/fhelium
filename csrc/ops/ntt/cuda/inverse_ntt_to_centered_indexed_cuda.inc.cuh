...
// Public indexed radix-2 inverse NTT centered-output entry points.

// ----------------------------------------------------------------------
// Inverse NTT with centered standard output
// ----------------------------------------------------------------------

template <typename scalar_t>
void launch_inverse_ntt_to_centered_indexed_cuda(
    torch::Tensor a,
...
void inverse_ntt_to_centered_indexed_inplace_cuda(
  ...
  AT_DISPATCH_INTEGRAL_TYPES(
      a.scalar_type(), "inverse_ntt_to_centered_indexed_cuda", ([&] {
        launch_inverse_ntt_to_centered_indexed_cuda<scalar_t>(batch_rows,
                                                              even_indices,
                                                              odd_indices,
                                                              inverse_twiddles,
                                                              rns_params);
