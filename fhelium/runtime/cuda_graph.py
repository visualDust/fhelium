...
from fhelium.runtime.buffer import CopyHandle, ReusableValueBuffer
...
class CudaGraphProgram(Generic[_OutputT]):
    ...
    :class:`~fhelium.runtime.ReusableValueBuffer`; CUDA Graph kernels capture
    ...
    Parameters captured by a closure, :class:`functools.partial`, or a callable
    ...
    def capture(
        ...
        *,
        ...
        Passing ``function`` directly is the primary API. Omitting it returns
