...
from fhelium.values import Ciphertext, Plaintext, PublicKey
...
class CkksEncryptor:
    ...
    supplied by :class:`~fhelium.legacy.engine.CkksEngine` at construction.
    """
    ...
    def _encrypt_rns_plaintext(
        ...
        *,
        ...
        ct0 = self.rns_runtime.add_standard(
            vpk0,
            pte0,
            include_p=include_p,
        )
        ct1 = self.rns_runtime.add_standard(
            vpk1,
            e1_tiled,
            include_p=include_p,
        )
    ...
    def encrypt_message(
        ...
        *,
        ...
        For slots $m$ in the configured generator order, compute
