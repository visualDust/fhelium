...
contiguous interval in the engine's QP parameter order, and callers
...
def slice_ntt_parameter_rows(
    ...
    Backends retain tables for the engine's complete QP row order,
