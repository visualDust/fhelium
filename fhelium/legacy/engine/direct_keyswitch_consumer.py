...
class DirectKeySwitchDigitConsumer(Protocol):
    r"""Define in-place consumption of one QP key-switch digit.
...
class StandardDirectKeySwitchDigitConsumer:
    """Transform a digit with ``RnsRuntime`` and then accumulate KSK products."""
    ...
    def consume_(
        ...
        *,
        ...
        """Apply the selected NTT, then accumulate both key components."""
...
class CompactTailFusedDirectKeySwitchDigitConsumer:
    """Execute the group16 compact-NTT and KSK-accumulate fused kernel.

    This consumer is an internal lowering target. Ordinary engine construction
    uses :class:`StandardDirectKeySwitchDigitConsumer` instead.
    """
    ...
    def consume_(
        ...
        *,
        ...
        """Transform and accumulate the digit through the fused native kernel."""
