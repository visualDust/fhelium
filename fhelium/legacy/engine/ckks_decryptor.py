...
from fhelium.values import Ciphertext, Plaintext, SecretKey
...
class CkksDecryptor:
    ...
    def decrypt(
        ...
        as coefficient-domain standard RNS in $[0,q_i)$. The direct decrypt path then
    ...
    def _decrypt_to_coefficient_standard_rns(
        ...
        if ciphertext.component_count == 3:
            ...
            return self.rns_runtime.add_standard(
                plaintext_rns,
                d2_s2,
                include_p=ciphertext.includes_p,
            )
    ...
    def _reconstruct_tail_q_coefficients_float64(
        ...
        The method selects the trailing one/two active Q rows, reduces
