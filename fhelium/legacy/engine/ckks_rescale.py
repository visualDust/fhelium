    ...
    * :meth:`_rescale_final_public_level_to_structural_base` performs the one
    ...
    def _rescale_component(
        ...
        *,
        ...
        Output has the ``remaining`` shape/dtype/device, $[0,q_i)$
    ...
    def _rescale_component_(
        ...
        *,
        ...
        $[0,q_i)$ output match :meth:`_rescale_component`. The
    ...
    def _drop_leading_scale_prime(
        ...
        *,
        ...
        standard residues in $[0,q_i)$, and ``prime_ids[1:]``. Output
        storage is independent.
        """
    ...
    def _drop_leading_scale_prime_(
        ...
        *,
        ...
        Surviving component views are overwritten with least nonnegative quotient
