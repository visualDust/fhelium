...
from fhelium.legacy.engine.galois import rotation_galois_element
from fhelium.native.wrapper import ckks_ops, rns_ops

if TYPE_CHECKING:
    from fhelium.legacy.engine.rns.layout import RnsDigitSpec
...
class HybridKeySwitcher:
    ...
    def _apply_key_switch_streaming(
        ...
        accumulators. The engine-owned digit consumer decides whether the
    ...
    def _switch_prepared_rotation(
        ...
        *,
        ...
        switched_c0 = self.rns_runtime.add_standard(rotated_c0, correction0)
