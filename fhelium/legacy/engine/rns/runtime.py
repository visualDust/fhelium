...
from fhelium.legacy.engine.rns.decomposition import HybridRnsDecomposition
...
from fhelium.legacy.engine.rns.layout import RnsLayout
from fhelium.legacy.engine.rns.parameters import (
    RnsParameterStore,
    RnsRowParameters,
)
from fhelium.legacy.engine.ntt import create_ntt_backend, prepare_ntt_tables
...
class RnsRuntime:
    ...
    def __init__(
        ...
        self.dtype = RnsExecutionFormat.select(ckks_config.moduli).dtype
        ...
        self.depth_row_starts = [
            self.rns_layout.start_row(depth)
    ...
    def rns_basis_depth_count(self) -> int:
        """Number of RNS row-suffix depths, including private structural depths."""

        return self.rns_chain.rns_basis_depth_count
    ...
    def _build_parameter_store(self) -> None:
        self.parameter_store = RnsParameterStore(
            ...
            rns_basis_depth_count=self.rns_basis_depth_count,
            depth_row_starts=self.depth_row_starts,
    ...
    def montgomery_mul_row_scalars_standard(
        ...
        *,
        ...
        rows. Polynomial domain is preserved. Output has least nonnegative
    ...
    def forward_montgomery_(
        ...
        *,
        ...
        polynomial modulo $X^N+1$ and $q_i$ in the backend's NTT
    ...
    def inverse_to_standard_(
        ...
        *,
        ...
        r"""Inverse NTT to coefficient/standard $[0,q_i)$ in place."""
    ...
    def __str__(self):
        return (
            ...
            f"N={self.config.N}, depths={self.rns_basis_depth_count}, "
