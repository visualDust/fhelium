...
class RnsLayout:
    ...
    def __init__(
        ...
        self.rns_basis_depth_count = chain.rns_basis_depth_count
        ...
        # authoritative per-depth metadata and these views are derived from it
        # exactly once.
        ...
        return tuple(
            RnsDigitSpec(
                ...
                component_row_ids=tuple(
                    prime_id - depth for prime_id in digit.prime_ids
                ),
            )
    ...
    def __str__(self) -> str:
        return (
            ...
            f"depths={self.rns_basis_depth_count}, "
